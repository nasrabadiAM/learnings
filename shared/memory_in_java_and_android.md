...
اگر دقت کنید چندین استک‌مموری داریم، در واقع هرکدام از این استک‌مموری‌ها مربوط به یک ترد است و اگر ترد جدیدی ساخته شود، یک استک مموری جداگانه به ‌‌آن اختصاص داده‌می‌شود. هیچکدام از استک ممور‌ی‌ها به اطلاعات یکدیگر دسترسی ندارند اما به آبجکت‌های heap دسترسی دارند. اینجاست که مشکل ConcurrentModificationError  ایجاد می‌شود.
