لیست چیست؟ 
---
لیست یک نوع داده انتزاعی یا 
abstract 
است که معمولا به یک سری از مقادیر یک نوع و ترتیبی گته می‌شود.

تعریف ریاضی لیست یک دنباله محدود است ونوع نامحدود آن استریم نامیده می‌شود.

از آنجا که لیست یک مفهو انتزاعی است، برای عینی شدن باید پیاده‌سازی شود

انواع معمول پیاده‌سازی لیست‌ها 
ArrayList
و
LinkedList
هستند.
...
http://developer.classpath.org/doc/java/util/List-source.html
